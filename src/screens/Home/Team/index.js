    ...
    <div id="team" className={styles.section}>
      <div className={cn("container", styles.container)}>
        <div className={styles.head}>
          <h2 className={cn("h2", styles.title)}>Meet our Team</h2>
          <div className={styles.info}>
            From all over the world, we have selected a team of experienced
            developers and marketers. Moreover, each of the employees has vast
